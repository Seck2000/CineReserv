...
namespace CineReserv.Controllers
{
    ...
    public class FacturationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Vérifier directement avec la base de données
            var user = await _context.Users.FirstOrDefaultAsync(u => u.Id == userId);
            if (user == null || user.TypeUtilisateur?.Trim() != "Fournisseur/Organisateur")
            {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync(u => u.Id == userId);
            var isSupplier = user != null && user.TypeUtilisateur?.Trim() == "Fournisseur/Organisateur";
        ...
        public async Task<IActionResult> Statistiques()
        {
            ...
            var statistiques = new StatistiquesFacturationViewModel
            {
                TotalRevenus = factures.Any() ? factures.Sum(f => f.Montant) : 0,
